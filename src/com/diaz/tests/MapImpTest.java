...
class MapImpTest {
  ...
  @Test
  void moveRobotToTheEdge() throws RobotException {
    this.map.moveRobotToTheEdge(this.id);
    int[] expected = {10, 0};
    assertArrayEquals(expected, this.robot.getCoordinates());
    assertEquals(Facing.EAST, this.robot.getOrientation());
  }
